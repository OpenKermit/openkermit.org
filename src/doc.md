...
- John Goerzen's pages about IKSD, the Internet Kermit Server Daemon, all offsite on www.complete.org:
  ...
  - [How to Run an Internet Kermit Server](https://www.complete.org/how-to-run-an-internet-kermit-server/)


## Kermit Project and Columbia resources

There has been much written about Kermit over the years, including several
books.  Because compatibility has been a key goal for C-Kermit for decades now,
most older material from the Kermit Project or Columbia University is still
applicable to modern C-Kermit installations.

The books here are treasures of detailed Kermit information; for instance, The
Kermit File Transfer Protocol was in print from 1986-2001 and used copies can
...
John Goerzen maintains Kermit mirrors on quux.org, for both the Columbia and Kermit Project FTP and HTTP sites.  See <https://kermit.mirrors.quux.org/>.
